...
*/
if(!function_exists('checkRequiredPost')){function checkRequiredPost($requiredField) {
...
if(!function_exists('getShopConfig')){function getShopConfig()
{
...
if(!function_exists('displayAmount')){function displayAmount($amount)
{
	global $shopConfig;
...
*/
if(!function_exists('queryString')){function queryString()
{
	$qString = array();
...
*/
if(!function_exists('setError')){function setError($errorMessage)
{
...
*/
if(!function_exists('displayError')){function displayError()
{
...
if(!function_exists('getPagingQuery')){function getPagingQuery($sql, $itemPerPage = 10)
{
...
*/
if(!function_exists('getPagingLink')){function getPagingLink($sql, $itemPerPage = 10, $strGet = '')
{
    global $etomite;
