...
$paypal['business']      = PAYPAL_BUSINESSNAME;
$paypal['site_url']      = PAYPAL_SITE_URL;
$paypal['image_url']     = PAYPAL_IMAGE_URL;
$paypal['success_url']   = PAYPAL_SUCCESS_URL;
$paypal['cancel_url']    = PAYPAL_CANCEL_URL;
$paypal['notify_url']    = PAYPAL_NOTIFY_URL;
$paypal['return_method'] = PAYPAL_RETURN_METHOD; //1=GET 2=POST--> Use post since we will need the return values to check if order is valid
$paypal['currency_code'] = PAYPAL_CURRENCY_CODE; //['USD,GBP,JPY,CAD,EUR']
$paypal['lc']            = PAYPAL_LC;
