...
//corrected sql statement to get the correct category name-Cris D
$sql = "SELECT cat_name, pd_name, pd_description, pd_price, pd_qty, pd_image
        FROM tbl_product AS pd, tbl_category AS cat
		WHERE pd.pd_id = $productId AND cat.cat_id = pd.cat_id";
