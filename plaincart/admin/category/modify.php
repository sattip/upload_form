...
<form action="processCategory.php?action=modify&catId=<?php echo $catId; ?>" method="post" enctype="multipart/form-data" name="frmCategory" id="frmCategory">
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="entryTable">
  <tr> 
   <td width="150" class="label">Ό&nu;&omicron;&mu;&alpha; &Kappa;&alpha;&tau;&eta;&gamma;&omicron;&rho;ί&alpha;&sigmaf;</td>
...
?>
    <br>
    <img src="<?php echo WEB_ROOT . CATEGORY_IMAGE_DIR . $cat_image; ?>"> &nbsp;&nbsp;<a href="javascript:deleteImage(<?php echo $cat_id; ?>);">&Delta;&iota;&alpha;&gamma;&rho;&alpha;&phi;ή &Epsilon;&iota;&kappa;ό&nu;&alpha;&sigmaf;</a> 
    <?php
	}
?>
   </td>
 ...
 <p align="center"> 
  <input name="btnModify" type="button" id="btnModify" value="Αποθήκευση" onClick="checkCategoryForm();" class="box">
  &nbsp;&nbsp;<input name="btnCancel" type="button" id="btnCancel" value="Ακύρωση" onClick="window.location.href='index.php';" class="box">
 </p>
</form>